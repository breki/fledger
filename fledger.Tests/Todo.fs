...
// todo 10: we need to format all decimals in the invariant mode
// todo 15: validator: the expected account totals should be validated
// todo 20: the validation should be exposed as a CLI command
// todo 30: add support for tags and posting comments
// todo 35: mark all subscriptions in the ledger with subscription tag
